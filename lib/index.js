    ...
    const manifest = {
        ...
        [
            ...
            */
            ...
            { plugin: { register: './plugins/aws-sns' }},
            { plugin: { register: './plugins/sns-endpoint' }},
            { plugin: { register: './plugins/aws-sqs' }},
            { plugin: { register: './plugins/aws-lambda' }},
            { plugin: { register: './plugins/aws-swf' }},
        ]
    };
